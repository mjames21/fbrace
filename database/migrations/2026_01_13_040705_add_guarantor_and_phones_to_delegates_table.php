...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('delegates', function (Blueprint $table) {
            // Phones (keep any existing "phone" column if you already have it)
            if (!Schema::hasColumn('delegates', 'phone_primary')) {
                $table->string('phone_primary', 32)->nullable()->after('phone');
            }
            ...
            // Guarantor relationship (many delegates -> one guarantor)
